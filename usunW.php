...
$idw=$_GET['idw']; //id plyty

$select = "DELETE FROM Wykonawcy where id=$idw";
$query = mysql_query($baza,$select);

echo '<h1>Wykonawca został usunięty</h1>';

echo "<p>za chwilę nastąpi przekierowanie do strony z wykonawcami...</p>";
