...
<div class="main">
  ...
  ?>
   ...
   <div class="content_spacer">
	...
	<!-- ==================================== srodek ===========================-->
      <h1><p><a href="login.php">Logowanie</a></p></h1>
	...
	<h3><table>
		<form action="loginS.php" method="POST">
			...
			<tr><td><input type="submit" value="dalej"></td></tr>
		</form>
	</table></h3>
	</center>
      <div class="clear"></div>
...
<div class="section footer">
  ...
  <div class="module strona">
          <p>Copyright &copy; 2012; Projekt: SzablonyStron.org - <a href="http://szablonystron.org">szablony stron www</a>, pomoc w <a href="http://linuxlabs.pl/pl,uslugi-linux">konfiguracje systemu linux</a> oraz <a href="http://ibisal.com">cms bielsko</a></p><!--link_baza_stop-->
    <div class="clear"></div>
  </div>
