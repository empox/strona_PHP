...
$select = "SELECT * FROM ALBUMY where id=$ida";
$query = mysql_query($baza,$select);
$wiersz = mysql_fetch_object($query);



echo '<h2> Czy napewno chcesz usunąć album: <br><br>'.$wiersz->TYTUL.'?</h2><br/><br/>';

echo '<h1><a href="usunA.php?ida='.$wiersz->ID.'">TAK</a>&nbsp&nbsp
	<a href="albumy.php">NIE</a></h1>';
