...
echo '<h2> Czy napewno chcesz usunąć wykonawcę: <br><br>'.$wiersz->NAZWA.'?</h2><br/><br/>';

echo '<h1><a href="usunW.php?idw='.$wiersz->ID.'">TAK</a>&nbsp&nbsp
	<a href="wykonawcy.php">NIE</a></h1>';
