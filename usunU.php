...
$num=$_GET['num']; //num jest ID_utworu
$idp=$_GET['idp']; //id plyty

$select = "DELETE FROM Utwory where id=$num";
$query = mysql_query($baza,$select);

echo '<h1>Utwór został‚ usunięty</h1>';

echo "<p>za chwilę nastąpi przekierowanie do strony z utworami...</p>";
