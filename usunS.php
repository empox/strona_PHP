...
if ($G=="g")
{
echo "<h1>Gatunek został usunięty</h1>";
echo "<p>Za chwilkę nastąpi przekierowanie na stronę ze słownikami...</p>";
$select = 'DELETE FROM GATUNKI where ID = '.$ID;
$query = mysql_query($baza, $select);
}

if ($G=="n")
{
echo "<h1>Nośnik został usunięty</h1>";
echo "<p>Za chwilkę nastąpi przekierowanie na stronę ze słownikami...</p>";
$select = 'DELETE FROM NOSNIKI where ID = '.$ID;
$query = mysql_query($baza, $select);
}
if ($G=="w")
{
echo "<h1>Wydawca został usunięty</h1>";
echo "<p>Za chwilkę nastąpi przekierowanie na stronę ze słownikami...</p>";
$select = 'DELETE FROM WYDAWCY where ID = '.$ID;
$query = mysql_query($baza, $select);
}
if ($G=="j")
{
echo "<h1>Język został usunięty</h1>";
echo "<p>Za chwilkę nastąpi przekierowanie na stronę ze słownikami...</p>";
$select = 'DELETE FROM JEZYKI where ID = '.$ID;
$query = mysql_query($baza, $select);
}
if ($G=="k")
{
echo "<h1>Kraj został usunięty</h1>";
echo "<p>Za chwilkę nastąpi przekierowanie na stronę ze słownikami...</p>";
$select = 'DELETE FROM KRAJE where ID = '.$ID;
$query = mysql_query($baza, $select);
}
if ($G=="r")
{
echo "<h1>Rola artysty została usunięta</h1>";
echo "<p>Za chwilkę nastąpi przekierowanie na stronę ze słownikami...</p>";
$select = 'DELETE FROM ROLE_A where ID = '.$ID;
$query = mysql_query($baza, $select);
}	
